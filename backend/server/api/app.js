...
if (require.main === module) {
  ...
  main().then((app) => app.listen(process.env.FLICK_PORT), utils.logEvent(requestId, constants.LOG_LEVELS.info, constants.RESPONSE_CODES.LOG_MESSAGE_ONLY, `Listening On Port ${process.env.FLICK_PORT}`))
}
